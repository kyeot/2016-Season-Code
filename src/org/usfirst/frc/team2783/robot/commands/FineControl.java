...
public class FineControl extends Command {
		    ...
		    protected void execute() {
		    	...
		    	Double leftOutput = (throttleValue + (throttleValue * skewValue))*0.5;
		    	Double rightOutput = (throttleValue - (throttleValue * skewValue))*0.5;
