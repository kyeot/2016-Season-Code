...
public class ShootRotation extends Command {
    ...
    protected void execute() {
    	...
    	// Assigns input for horizontal rotation to RPM -100 to 100
    	double horizontalAxisRpmInput = manipulatorHorizontalAxisInput * 100;
    	...
    	// Assigns input for vertical rotation to RPM -100 to 100
    	double verticalAxisRpmInput = manipulatorAxisInput * 100;
